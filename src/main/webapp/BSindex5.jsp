    ...
    <div class="form" style="margin-top: 40px;">
      <form action="<%=request.getContextPath()%>/BSServlet?key=addfruit" method="post">
        <div class="add">
          ...
          <span class="add_text"><input type="text" name="fid1" id="fid1" value="" /></span>
        </div>
        <div class="add">
          <span class="add_tit">水果 ：</span>
          <span class="add_text"><input type="text" name="fname1" id="fname1" value="" /></span>
        </div>
        ...
        <div class="add">
          ...
          <span class="add_text"><input type="text" name="up1" id="up1" value="" /></span>
        </div>

        <div class="add">
          <span class="add_tit" >商品简介 ：</span>
          <span class="add_text"><input type="text" class="long" name="t11" id="t11" value="" /></span>
        </div>

        <div class="add">
          <span class="add_tit">温馨提示 ：</span>
          <span class="add_text"><input type="text" class="long" name="t21" id="t21" value="" /></span>
        </div>
